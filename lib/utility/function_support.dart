...
import 'package:vhks/ui/gps_log_item.dart';
...
class FunctionSupport{
    ...
    double distanceToSegment(LatLng point, LatLng a, LatLng b) {
        final LatLng AP = LatLng(point.latitude - a.latitude, point.longitude - a.longitude);
        final LatLng AB = LatLng(b.latitude - a.latitude, b.longitude - a.longitude);

        final double ab2 = AB.latitude * AB.latitude + AB.longitude * AB.longitude;
        final double ap_ab = AP.latitude * AB.latitude + AP.longitude * AB.longitude;
    ...
    // Canh bao
    Future<void> showWarningDialog(BuildContext context, String content, String imgAssets) async {
            ...
            builder: (BuildContext context) {
                return AlertDialog(
                    title: Center(
                        child: Text(
                            "Cảnh báo",
                            style: TextStyle(fontSize: 22.0, color: Colors.redAccent, fontWeight: FontWeight.w600),
                        ),
                    ),
                    content: Column(
                    ...
                    actionsAlignment: MainAxisAlignment.center, // Căn giữa các action
                    actions: [
                        TextButton(
                            onPressed: () {
                                audioPlayer.stop();
                            ...
                            child: Text("Đóng", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white),),
                            style: ButtonStyle(
                            ...
                            child: Column(
                                ...
                                children: [
                                    ...
                                    Center(
                                        child: Text(
                                            "Thông tin liên hệ",
                                            style: TextStyle(fontSize: 20.0, color: Colors.blueAccent, fontWeight: FontWeight.w600)
                                        ),
                                    ),
                                            ...
                                            GestureDetector(
                                                ...
                                                child: Text(
                                                    ...
                                                    style: TextStyle(
                                                        ...
                                                        decorationColor: Colors.blueAccent, // Màu gạch chân
    ...
    // Dialog select ship
    void showSelectShipDialog(BuildContext outerContext, String title, List<LoginResponse> ships, Function(LoginResponse) onTap) {
        showModalBottomSheet(
                    ...
                    child: Container(
                        ...
                        child: Column(
                            ...
                            children: [
                                ...
                                Text(
                                    title,
                                    style: TextStyle(fontSize: 18.0, color: Colors.blueAccent, fontWeight: FontWeight.w600)
                                ),
                                const SizedBox(height: 10,),
                                // List ship
                                Flexible(
    ...
    void showSelectFeeDialog(BuildContext outerContext, String shipNumber, String shipId,  String status, TokenResponse tokenResponse) {
        showModalBottomSheet(
            context: outerContext,
            isScrollControlled: true,
            shape: const RoundedRectangleBorder(
                            ...
                            child: Column(
                                ...
                                children: [
                                    ...
                                    buildSelectFee(
                                        ...
                                        onTap: () {
                                            showSnackbar(outerContext, "Vui lòng liên hệ với tổng đài để tiếp tục sử dụng dịch vụ", Colors.orangeAccent.shade100);
                                    ...
                                    buildSelectFee(
                                        ...
                                        onTap: () {
                                            showSnackbar(outerContext, "Vui lòng liên hệ với tổng đài để kích hoạt lại dịch vụ", Colors.redAccent.shade100);
                                            Navigator.pop(builderContext);
                                        },
                                    ) : SizedBox.shrink(),
                                    SizedBox(height: 10),
                                    buildSelectFee(
                                        ...
                                        onTap: () {
                                            ...
                                            Future.delayed(Duration(milliseconds: 200), () {
                                                navigateToScreen(outerContext, FeeHistoryScreen(shipNumber: shipNumber, shipId: shipId, tokenResponse: tokenResponse));
                                            });
                                        },
                                    ),
                                ],
    ...
    Widget buildSelectFee({required String title, required String imagePath, required Color color, required VoidCallback onTap}) {
        return InkWell(
            onTap: onTap,
            child: Container(
    ...
    // Chon thoi gian
    Future<void> selectDateTime(BuildContext context, DateTime firstDate, Function(DateTime) onDateTimeSelected) async {
        ...
        if (pickedDate != null) {
            final DateTime finalDateTime = DateTime.utc(
                pickedDate.year,
                pickedDate.month,
                pickedDate.day
            );
    ...
    DateTime parseDateString(String dateString) {
        try {
            ...
            throw FormatException("Chuỗi không đúng định dạng dd/MM/yyyy: $dateString");
        }
    }
    ...
    Color setColorElapsedTime(String inputDateTime){
        ...
        if(elapsedTime >= 240){ // Tren 4 gio
            return Colors.redAccent;
        }else if(210 <= elapsedTime && elapsedTime <= 240){  // Tu 3,5 den 4 gio
