...
import 'package:vhks/ui/ship_info_item.dart';
...
class ProfileScreen extends StatefulWidget {
    ...
    const ProfileScreen({Key? key, required this.ships, required this.tokenResponse}) : super(key: key);
                                            ...
                                            children: [
                                                ...
                                                Text(
                                                    listShipNumber.isNotEmpty
                                                        ...
                                                        ? listShipNumber.take(3).map((shipNumber) => shipNumber.toString()).join('\n') + '\n...+${listShipNumber.length-3}'
                                                        : listShipNumber.map((shipNumber) => shipNumber.toString()).join('\n'))
                                                        : "",
                                                    style: TextStyle(
                                                        fontSize: 18,
                                                        fontWeight: FontWeight.bold,
                                            ...
                                            children: [
                                                ...
                                                Text(
                                                    listCaptain.isNotEmpty
                                                        ...
                                                        ? listCaptain.take(3).map((shipNumber) => shipNumber.toString()).join('\n') + '\n...+${listCaptain.length-3}'
                                                        : listCaptain.map((shipNumber) => shipNumber.toString()).join('\n'))
                                                        : "",
                                                    style: TextStyle(
                                                        fontSize: 18,
                                                        fontWeight: FontWeight.bold,
                            ...
                            InkWell(
                                onTap: (){
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                            builder: (context) => FeeScreen(ships: widget.ships, tokenResponse: widget.tokenResponse,),
                                        ),
                                    );
                                },
                                child: Container(
