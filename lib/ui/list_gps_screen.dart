...
class _ListGpsScreenState extends State<ListGpsScreen> {
  ...
  void initState() {
        ...
        if(firstGps!=null && lastGps!=null) {
            if(firstGps.byteCount == 10 && lastGps.byteCount == 10 || firstGps.byteCount == 15 && lastGps.byteCount == 15){
          ...
          body: Container(
              ...
              child: Column(
                  ...
                  children: [
                      ...
                      const Text(
                          "Nhật ký hành trình",
                          style: TextStyle(color: Colors.blueAccent, fontSize: 18.0, fontWeight: FontWeight.w600),
                      ),
